...
_ansel()
{
  ...
  dopts="all cache camctl camsupport control dev fswatch history imageio input ioporder lighttable lua masks memory nan opencl params perf pipe print signal sql undo"
